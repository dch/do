...
opts = [
    ...
    cfg.StrOpt('config_path', default='/etc/rc.digitalocean.d/',
               help='Defines path where droplet ID is stored'),
]
...
class InitManager(object):
    ...
    def _check_new_instance(self, instance_id):
        return not os.path.exists(CONF.config_path + instance_id + '.conf')
    ...
    def configure_host(self):
        ...
        if self._check_new_instance(instance_id):
            ...
            LOG.info('cloud-init has run on this droplet - skipping.')
