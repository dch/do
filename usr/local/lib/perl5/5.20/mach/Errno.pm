...
"amd64-freebsd-thread-multi-10.1-release-p31" or
	die "Errno architecture (amd64-freebsd-thread-multi-10.1-release-p31) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
